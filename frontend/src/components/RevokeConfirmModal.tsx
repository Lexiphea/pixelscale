...
export default function RevokeConfirmModal({ isOpen, onClose, onConfirm, isRevoking, filename }: RevokeConfirmModalProps) {
    return (
                ...
                <div className="p-8 space-y-6 relative z-10">
                    ...
                    <div className="space-y-2 text-center">
                        ...
                        <DialogDescription className="text-muted-foreground text-sm leading-relaxed">
                            {filename ? (
                                <>
                                    Are you sure you want to stop sharing <span className="text-white font-semibold italic">"{filename}"</span>?
                                    This action is permanent and cannot be undone.
                                </>
                            ) : (
                                "Are you sure you want to stop sharing this image? This action will immediately invalidate the link."
                            )}
                        </DialogDescription>
                    </div>
